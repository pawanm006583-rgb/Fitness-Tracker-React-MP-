import { Bell, Command, Search, ChevronDown, User, LogOut, Settings, Sun, Moon } from 'lucide-react';
  ...
  return (
    <header className="h-14 border-b border-border-subtle flex items-center justify-between px-6 bg-bg-main/50 backdrop-blur-md sticky top-0 z-[90]">
      ...
      <div className="flex items-center gap-4">
        ...
        <button 
          onClick={toggleTheme}
          className="w-8 h-8 flex items-center justify-center rounded-md text-white/50 hover:text-white hover:bg-white/5 transition-all"
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-brand rounded-full border-2 border-bg-main" />
          </button>
            ...
            {showNotifications && (
              ...
              >
                <div className="p-3 border-b border-border-subtle flex items-center justify-between">
                  ...
                  <button className="text-[10px] text-brand hover:underline">Mark all read</button>
                </div>
