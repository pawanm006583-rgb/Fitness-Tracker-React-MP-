...
const SCENE_1 = '/Users/pawansushilmiahra/.gemini/antigravity/brain/07958bdf-0a32-4896-b266-795082fc04a6/cinematic_athlete_deadlift_neural_1778684230846.png';
const SCENE_2 = '/Users/pawansushilmiahra/.gemini/antigravity/brain/07958bdf-0a32-4896-b266-795082fc04a6/cinematic_athlete_recovery_neural_1778684466172.png';

const HUDOverlay = ({ icon: Icon, label, value, color }: any) => (
...
const CinematicScene = ({ img, title, subtitle, isActive, hudData }: any) => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-10">
        ...
        <div className="absolute bottom-32 left-10 hidden lg:flex flex-col gap-4">
           {hudData.slice(0, 2).map((h: any, i: number) => (
             <motion.div
               key={h.label}
        ...
        <div className="absolute bottom-32 right-10 hidden lg:flex flex-col gap-4 text-right">
           {hudData.slice(2).map((h: any, i: number) => (
             <motion.div
               key={h.label}
               initial={{ opacity: 0, x: 50 }}
               animate={isActive ? { opacity: 1, x: 0 } : {}}
...
export const CinematicModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
